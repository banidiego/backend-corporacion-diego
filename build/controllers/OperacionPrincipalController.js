...
class OperacionPrincipalController {
    ...
    ListaMensualAnoMesTipoOrigen(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('SELECT * FROM OperacionPrincipal WHERE Ano = ? and Mes = ? and TipoOrigen = ? Order by FechaOperacion', [ano, mes, tipoOrigen], function (err, datos, fields) {
                if (err) {
